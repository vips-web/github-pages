  ...
  <div class="container">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
        <li class="selected">Français<i class="fas fa-check"></i></li>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="qaModalLabel">Qu'est ce qu'une crypto monnaie? Q＆R</h4>
                </div>
                <div class="modal-body">
                  ...
                  <p>
                    <span>Q. Y-a-t-il un frais d'entretien pour garder un portefeuille ?</span><br>
