  ...
  <div class="container">
    ...
    <div class="row">
      <div class="holding-header">
        <p>
          The initial supply of VIPS is 60 billion.<br>
          +<br>
          Additional supply through PoS and PoW will be 10 billion in total.<br>
          （This will end in 2120.）
        </p>
      </div>
      ...
      <div class="col-md-12 col-sm-12">
        ...
        <p>
          Self lock-up for 2019: total about 23.5BN vips<br>
          <br>
          ...
          <a href="#" class="holding-lockup-link" data-toggle="modal" data-target="#lockupModal">
            Self lock-up address&nbsp;&nbsp;<i class="far fa-window-restore"></i>
          </a>
        </p>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="lockupModalLabel">Self lock-up address</h4>
        </div>
