    ...
    <div class="row">
      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="about-text">
          ...
          <p class="bl_about-button text-center">
            <a class="button button-bw" href="https://github.com/vips-web/github-pages/raw/master/download/mid-term_action_plan_ja.pdf" target="_blank">中期アクションプラン&nbsp;&nbsp;<i class="fas fa-file-pdf"></i></a>
          </p>
          <div class="bl_movie">
